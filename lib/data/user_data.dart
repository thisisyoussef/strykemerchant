...
class VerifiedUserData {
  ...
  VerifiedUserData({this.user, this.token});

  VerifiedUserData.fromJson(Map<String, dynamic> json) {
    user = json['Merchant'] != null
        ? new VerifiedUser.fromJson(json['Merchant'])
        : null;
    token = json['token'];
  }
...
/*
        loyalty.add(new Null.fromJson(v));
*/
      });
    }
...
class SignedUpUserData {
  SignedUpUser user;
  String token;

  SignedUpUserData({this.user, this.token});

  SignedUpUserData.fromJson(Map<String, dynamic> json) {
    user = json['Merchant'] != null
        ? new SignedUpUser.fromJson(json['Merchant'])
        : null;
    token = json['token'];
...
class SignedUpUser {
  ...
  SignedUpUser.fromJson(Map<String, dynamic> json) {
    address =
        json['address'] != null ? new Address.fromJson(json['address']) : null;
    status = json['status'];
    numberOfTransaction = json['numberOfTransaction'];
